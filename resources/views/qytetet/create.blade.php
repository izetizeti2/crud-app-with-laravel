...
<main class="container mx-auto px-6 py-8 flex-grow">
    <div class="mb-4 flex items-start flex-col">
        <h1 class="text-4xl font-extrabold text-gray-800 mb-6">Shto një qytet të ri</h1>

        <a href="{{ url('/qytetet/qytetet') }}" class="text-blue-500 hover:underline text-lg mt-4"> &larr; Kthehu tek tabela</a>
    </div>

    <form action="{{ route('qytetet.store') }}" method="POST" id="updateFrom" class="bg-white shadow-lg rounded-lg p-8">
        @csrf
        <div class="mb-6">
