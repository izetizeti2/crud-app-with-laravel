...
<title>Shto nje Qytetar te ri</title>
...
<main class="container mx-auto px-6 py-8 flex-grow">
    <h1 class="text-4xl font-extrabold text-gray-800 mb-6">Shto një Qytetar të ri</h1>

    <div class="mb-4 flex items-center justify-between">
        <a href="{{url('/') }}" class="text-blue-500 hover:underline text-lg"> &larr; Kthehu tek tabela</a>
    </div>

    <form action="{{ route('qytetaret.store') }}" method="POST" id="createFrom" class="bg-white shadow-lg rounded-lg p-8">
        @csrf
        <div class="mb-6">
...
<script>
    document.getElementById('createFrom').addEventListener("submit", function(e){
        e.preventDefault();
        ...
        swal.fire({
            ...
            text : 'qytetari u shtua me sukses.',
            timer: 2000,
